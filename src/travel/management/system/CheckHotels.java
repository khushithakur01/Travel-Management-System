...
public class CheckHotels  extends JFrame implements Runnable{
    ...
    JLabel caption;
    public void run(){
        String []text=new String[]{"JW Marriott","Madarin Oriental HOtel","Four Seasons Hotel","Raddisson Bule Hotel","Classio Hotel","The Bay Club Hotel ","Breeze Blow Hotel","The Taj Hotel","Happy Morning Motel","River View Hotel"};
        try{
            for(int i=0;i<=9;i++){
